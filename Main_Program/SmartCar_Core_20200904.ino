 ...
 * @Author: Liwen Zhong
 * @Date: 2020-12-01 18:00:25
 * @LastEditTime: 2020-12-09 14:40:48
 * @LastEditors: Liwen Zhong
 */
#include <IRremote.h>
#include <Servo.h>
#include <stdio.h>
...
#define turnSpeed 120 //PWM(Motor speed/Speed)
...
void irremote_mode(void)
{
  if (func_mode == IRremote)
  {
    ...
    case BACK:
      ...
      break;
    case LEFT:
      left(false, turnSpeed);
      break;
    case RIGHT:
      right(false, turnSpeed);
      break;
    case STOP:
      stop();
      break;
